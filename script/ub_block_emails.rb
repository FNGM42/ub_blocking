  ...
  require 'net/smtp'
  #require './patron.rb'
  require '/home/cfishburn/RubymineProjects/ub_blocking/app/models/patron'
  #require 'config/environment.rb'
  #ENV['RAILS_ENV'] = "development"
  #require '/home/cfishburn/RubymineProjects/ub_blocking/config/environment.rb'
...
#MESSAGE_END
  ...
  def update_blocking_table
    ...
    @ub_report_string.each do |row|
      ...
      @patron_name = row.at_xpath("Column1").text.to_s + " " +row.at_xpath("Column2").text.to_s
